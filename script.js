const quizQuestions = {
    "Anatomy and Physiology": [
        ...
        {
            question: "Which muscle is responsible for the heartbeat?",
            options: ["Skeletal Muscle", "Cardiac Muscle", "Smooth Muscle", "Biceps"],
            correct: 1
        },
    ],
    "Pharmacology": [
        {
            question: "What is the study of how drugs interact with the body called?",
            options: ["Pharmacokinetics", "Pharmacodynamics", "Toxicology", "Biochemistry"],
            correct: 1
        },
        {
            question: "Which of the following is an analgesic?",
            options: ["Ibuprofen", "Insulin", "Amoxicillin", "Aspirin"],
            correct: 3
        },
    ],
    "Nursing Ethics": [
        {
            question: "What principle of nursing ethics emphasizes doing good for the patient?",
            options: ["Autonomy", "Beneficence", "Justice", "Nonmaleficence"],
            correct: 1
        },
        {
            question: "What is the term for keeping patient information private?",
            options: ["Accountability", "Fidelity", "Confidentiality", "Veracity"],
            correct: 2
        },
    ]
};
